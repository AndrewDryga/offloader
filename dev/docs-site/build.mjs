...
function header(active) {
  const link = (href, label, cls = "") => `<li><a href="${href}"${cls ? ` class="${cls}"` : ""}>${label}</a></li>`;
  ...
  <nav class="wrap nav" aria-label="Primary">
    ...
    <ul class="nav-links">
      ...
      ${link("../index.html#start", "Run it", "nav-cta")}
    </ul>
  </nav>
</header>`;
}
...
function sidebar(activeSlug) {
  ...
  return `<details id="docsnav" class="docs-nav" open>
    ...
    <a class="docs-home" href="index.html"${activeSlug === undefined ? ' aria-current="page"' : ""}>${BRAND_MARK} Docs home</a>
    ${groups}
    </nav>
  </details>`;
}
...
const FOOT = `<footer class="doc-foot">
  <div class="wrap doc-foot-inner">
    <p class="foot-word">${BRAND_MARK} Offloader</p>
    <nav class="doc-foot-links" aria-label="Footer">
      <a href="index.html">Docs home</a>
      <a href="quickstart.html">Quickstart</a>
      <a href="../index.html">Marketing site</a>
      <a href="${REPO}">GitHub</a>
    </nav>
    <p class="doc-foot-legal">Docs track shipped behavior. Freshness is minutes to hours, not real-time. © 2026 Offloader.</p>
  </div>
</footer>`;
