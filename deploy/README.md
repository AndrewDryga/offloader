...
| **Image** | **Pull from GHCR** and pin a released tag (`ghcr.io/andrewdryga/offloader:0.1.3`); never `:latest`. The rolling `:edge` tag tracks `main`. Upgrade = new tag; rollback = old tag. |
