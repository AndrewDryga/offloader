...
cosign verify --key <pubkey> ghcr.io/andrewdryga/offloader:0.1.3
```

## Publishing

Pin image tags (`ghcr.io/andrewdryga/offloader:0.1.3`, never `:latest`), and publish
